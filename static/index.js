...
$('document').ready(function () {
	...
	$("#switchInputType").click(function (event) {
		...
		if ($('.buttonResponse').is(":visible")) {
			...
			$("#switchInputType").attr("static", "Images/multipleChoice.png");
		}

		else {
			//$("#switchInputType").attr("src", "Images/keyboard.png");
			$("#switchInputType").attr("static", "Images/keyboard.png");
		}
		$('textarea').toggle();
	...
	$("textarea").keypress(function (event) {
		...
		if (event.which === 13) {
			console.log("send msg event 13, line 81")
...
function send(text) {
	...
	$.ajax({
		...
		success: function (data) {
			console.log(data);
			newRecievedMessage(JSON.stringify(data['ans']));
		},
		error: function (data) {
			console.log("wrong");
			console.log(data);
			//newRecievedMessage(JSON.stringify(data.ans));
			newRecievedMessage("Connect Error");
		}
	});
...
function updateRec() {
	...
	if (recognition) {
		...
		$("#rec").attr("static", "Images/MicrophoneOff.png");
	} else {
		//$("#rec").attr("src", "Images/microphone.png");
		$("#rec").attr("static", "Images/microphone.png");
